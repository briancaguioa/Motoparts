						 ...
						 <tr>
						 	...
						 	<td>
						 		<?php if($order['status']=="pending") { ?>
						 			<a href="../controller/complete_order.php?id=<?php echo $order['id']; ?>" class="btn btn-success">Complete Order</a>
						 			<a href="../controller/cancel_order.php?id=<?php echo $order['id']; ?>" class="btn btn-danger">Cancel Order</a>
						 		<?php }; ?>
						 	</td>
						 </tr>
						<?php } ?>
